...
console.log(students[1] === copyStudents[1]) //true
...
//let newDeepCopyStudents = topStudents.concat(deepCopyStudents); // old school.
...
const addFriends = (students) => {
    ...
    let friendsName = (friends) => {
        return friends.map( st => st.name)
    }

    let studensWithFriends = students.map( (st) => ({...st, friends: friendsName(students.filter( s => s.name !== st.name)) }))

    return studensWithFriends
    //..............................
}
